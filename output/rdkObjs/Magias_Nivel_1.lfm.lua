...
local function constructNew_frmMagias_Nivel_1()
...
function newfrmMagias_Nivel_1()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmMagias_Nivel_1();
      end,
      function()
...
local _frmMagias_Nivel_1 = {
    newEditor = newfrmMagias_Nivel_1, 
    new = newfrmMagias_Nivel_1, 
    name = "frmMagias_Nivel_1", 
    dataType = "", 
    formType = "undefined", 
...
frmMagias_Nivel_1 = _frmMagias_Nivel_1;
Firecast.registrarForm(_frmMagias_Nivel_1);

return _frmMagias_Nivel_1;
